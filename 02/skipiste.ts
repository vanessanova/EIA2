...
//5 Schleife Bäume.Anzahl,wie oft und wo)
  /**      for (let i: number = 0; i < 5; i++) {
        ...
        //6 Schleifen und Startkoordinaten für ARRAYS schnee,Wolken,Skifahrer, Darstellungsbereich
    ...
    function animate(): void {
        ...
        for (let i: number = 0; i < schneeX.length; i++) {
            ...
            schneeY[i] += Math.random(); // Bewegung und Geschwindigkeit der schnee y-Achse. Je größer die Zahl desto schneller die Bewegung
            snowflake(schneeX[i], schneeY[i]); //Funktionsaufruf schnee, Übergabe X und Y-Werte
        }
